...
pub mod fov {
        ...
        H: Fn(i32, i32) -> i32,
    {
        ...
        pub fn compute(&self, origin: LevelPoint, range_limit: i32) {
            (self.set_visible)(origin.x, origin.y);
            for octant in 0..8 {
                self.compute_octant(
                    octant,
                    &origin,
        ...
        fn translate_x(&self, octant: u32, x: u32, y: u32, origin: &LevelPoint) -> i32 {
            match octant {
                0 => origin.x + x as i32,
                1 => origin.x + y as i32,
                2 => origin.x - y as i32,
        ...
        fn translate_y(&self, octant: u32, x: u32, y: u32, origin: &LevelPoint) -> i32 {
            match octant {
                0 => origin.y - y as i32,
                1 => origin.y - x as i32,
                2 => origin.y - x as i32,
